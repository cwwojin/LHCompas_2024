...
from compas.trainers import DLinearLightningModule
...
def runExp_DLinear():
    ...
    model_name = f"DLinear_{'indiv' if model.model.individual else 'base'}_in_{data_module.input_steps}_out_{data_module.output_steps}_train_{len(data_module.train)}_val_{cfg.VAL_SIZE}_{timestamp}"
