...
from compas.trainers import CNN1DSimpleLightningModule  # Adjust the import
...
def runExp_CNN1D():
    ...
    model_name = f"CNN1D_in_{data_module.input_steps}_out_{data_module.output_steps}_train_{len(data_module.train)}_val_{cfg.VAL_SIZE}_{timestamp}"
